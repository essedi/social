...
class MailThread(models.AbstractModel):
    ...
    def _whatsapp_get_channel(self, field_name, gateway):
        ...
        gateway_channel = GatewayChannel.search(
        ...
        elif gateway_channel.gateway_token != sanitized_number:
            # Only one configuration per partner and gateway: the user
            # explicitly sends to this number, so it becomes the partner token.
            gateway_channel.gateway_token = sanitized_number
