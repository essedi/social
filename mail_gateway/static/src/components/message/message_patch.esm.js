...
patch(Message.prototype, {
    onClickLinkGatewayToThread() {
        this.env.services.action.doAction({
            ...
            context: {default_message_id: this.props.message.id},
            views: [[false, "form"]],
            target: "new",
        });
    },
    ...
    openGatewayThreadRecord() {
        this.env.services.action.doAction({
            type: "ir.actions.act_window",
            res_id: this.props.message.gateway_thread_data.id,
            res_model: this.props.message.gateway_thread_data.model,
            views: [[false, "form"]],
        });
    },
});
